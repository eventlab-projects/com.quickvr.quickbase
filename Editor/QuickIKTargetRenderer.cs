...
namespace QuickVR
{
    ...
    public class QuickIKTargetRendererData
    {
    ...
    //[Serializable]
    //public class QuickIKTargetRenderer : ScriptableObject, IQuickIKTargetRenderer
    public class QuickIKTargetRenderer : IQuickIKTargetRenderer
    {
        [SerializeField] private QuickIKTargetRendererData m_Data;
        ...
        public void Initialize(QuickIKTargetRendererData data)
        {
            m_Data = data;
        }
        ...
        public static Material material
        {
            get
            {
                if (!s_Material)
                {
                    var shader = QuickAnimationRiggingEditorHelper.LoadShader("BoneHandles.shader");
        ...
        public static RigEffectorData.Style defaultStyle
        {
            get
            {
                ...
                {
                    shape = QuickAnimationRiggingEditorHelper.LoadShape("LocatorEffector.asset"),
                ...
                case EventType.MouseDown:
                    {
                        ...
                        if (HandleUtility.nearestControl == id && evt.button == 0)
                        {
                            ...
                            if (!SceneVisibilityManager.instance.IsPickingDisabled(targetGameObject, false))
                            {
                                ...
                                QuickAnimationRiggingEditorHelper.HandleClickSelection(targetGameObject, evt);
                                evt.Use();
                            }
                        }
                        break;
